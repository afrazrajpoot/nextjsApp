...
const Sidebar = () => {
  return (
    <aside className="fixed  top-[3vw] hidden lg:block ">
      <div className="flex items-start gap-[0.4vw] bg-white  border-[1px] border-[#F1F5F9] w-full max-w-[20vw] lg:max-w-[16vw] ml-[8vw] sm:w-[45vw]  px-[1vw] py-[3vw]">
        ...
        <div>
          ...
          <p className="text-[#64748B] text-[0.8vw]  sm:text-[1vw]  mt-[-0.2vw]">
            neurotic@taildo.com
          </p>
        </div>
      </div>
      <div className="h-screen  w-full bg-white  fixed  sm:max-w-[20vw] lg:max-w-[16vw] ml-[8vw] p-[1vw] flex flex-col gap-[4vw]">
