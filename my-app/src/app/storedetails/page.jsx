...
const StoreDetails = () => {
  ...
  return (
    ...
    <main className='w-full'>
        <nav className='w-full max-w-[90vw] mx-auto mt-[12vw] sm:mt-[8vw] lg:mt-0 p-[2vw]'>
        ...
        <section className='w-full flex flex-col lg:flex-row items-start max-w-[90vw] mx-auto mt-[10vw] md:mt-[2vw]'>
            ...
            <footer className='w-full mt-[10vw] md:mt-[2vw] ml-[2vw] rounded-md p-[5vw] lg:p-[2vw] bg-[#FF689A1A]'>
        ...
        <section className='w-full flex flex-col lg:flex-row items-start max-w-[90vw] mx-auto mt-[10vw] md:mt-[2vw]'>
            ...
            <p className='text-[#171717] text-[4vw] sm:text-[2vw] lg:text-[1vw] mt-[5vw] sm:mt-[3vw] lg:mt-[1vw] w-full md:max-w-[70vw]'>Handy Seamless Transitions support any resolution of your project. Starting with the
            ...
            <aside className='w-full lg:max-w-[24vw] p-[2vw] mt-[10vw] md:mt-[2vw] border-[1px] border-[525252] rounded-lg lg:ml-[2vw]'>
