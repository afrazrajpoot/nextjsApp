  ...
  return (
    <main style={{ backgroundImage: "url('/img/hero1.png')"}} className="w-full h-screen bg-cover bg-center">
      <aside className="pt-[20vw] sm:pt-[10vw] lg:pt-[6vw] ml-[6vw] md:ml-[9vw] mt-[8vw] md:mt-0 w-full max-w-[90vw]  md:max-w-[50vw] p-[1vw]">
         <button className="bg-[#3D3D3D] text-[4vw] sm:text-[2vw] lg:text-[1vw] hover:bg-[#333333] text-[#fff] p-[2.5vw] md:p-[0.6vw] rounded-full w-full max-w-[35vw] sm:max-w-[18vw] lg:max-w-[10vw] text-center">SONDUCKFILM</button>
      ...
      <p className="w-full text-[4vw] mt-[3vw] sm:text-[2vw] lg:text-[1vw] md:mt-[1vw] text-[#B0B0B0] sm:max-w-[40vw] lg:max-w-[30vw]">Find what you need on Sonduck Film, Discover millions of video templates, stock footage, audio & more. All for one low cost.</p>
      ...
      <TextField
            ...
            InputProps={{ startAdornment: (  <SearchIcon className="text-[#FF387A]"/>  ),
              className: "text-gray-800 bg-[#F6F6F6] text-[4vw] sm:text-[2vw] lg:text-[1vw] focus:outline-none focus:shadow-md p-[0.3vw] focus:outline-none rounded-md",
              style: { padding: "0.3vw"},}}
            sx={{
              "& input": {
          ...
          />
          <button className="bg-[#FF387A] text-[4vw] mt-[3vw] md:mt-0 sm:text-[2vw] lg:text-[1vw] md:ml-[1vw] hover:shadow-md hover:bg-[#ff387af1] text-[#fff] p-[2.5vw] md:p-[0.9vw] rounded-md w-full md:max-w-[10vw] text-center">SEARCH</button>
      </section>
      </aside>
      ...
      <article className="w-full relative flex flex-col items-center justify-center mt-[10vw] sm:mt-[6vw] lg:mt-[2vw] py-[6vw] md:py-[2vw] bg-[#171717]">
        ...
        <h1 className="text-[5.5vw] sm:text-[3.5vw] lg:text-[2.5vw] mt-[2vw] font-semibold text-[#fff] text-center">Unlock Your Potential as a <br /> <span className="text-[#FF689A]">Creator</span> with Sonduck</h1>
        <p className="text-[3.8vw] sm:text-[1.8vw] lg:text-[0.8vw] mt-[1vw] text-[#D4D4D4] text-center w-full max-w-[80vw] sm:max-w-[70vw] lg:max-w-[47vw]">Experience the collaboration of numerous creators and an expanding selection of courses. Register now and become a part of a community comprising over 10,000 local and international creators. Utilize our Course Editor, and showcase your expertise by publishing your finest course on the Sonduck Course Library.</p>
