...
const Store = () => {
  return (
    <main className='w-full'>
        ...
        <button className="bg-[#FFFF] ml-[0.5vw] border-[1px] hidden md:block border-[#525252] font-medium hover:font-medium text-[3.5vw] md:text-[1vw]  hover:text-white hover:shadow-md hover:bg-[#ff387af6] text-[#525252] p-[2.5vw] md:p-[0.5vw] rounded-md w-full max-w-[30vw] md:max-w-[8vw] text-center">Premiere Pro</button>
        </section>
        <section className='flex items-center w-full md:max-w-[30vw] justify-end'>
            <p className='text-[#525252] w-full max-w-[15vw] md:max-w-[5vw] text-[4vw] md:text-[1vw]'>Sort by</p>
            <Button endIcon={<ImportExportSharpIcon />} variant="outlined" className='bg-[#FFFF] ml-[0.5vw] border-[1px] border-[#525252] font-medium hover:font-medium text-[3.5vw] md:text-[1vw]  hover:text-white hover:shadow-md hover:bg-[#ff387af6] text-[#525252] p-[2.5vw] md:p-[0.5vw] rounded-md w-full max-w-[40vw] md:max-w-[8vw] text-center' >Release</Button>
        </section>
         </nav>
