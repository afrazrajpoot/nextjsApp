    ...
    <main className='relative w-full sm:max-w-[40vw] lg:max-w-[25vw] m-[1vw]'>
        ...
        <div className="flex items-center mt-[1vw] justify-between">
            <p className='flex items-center'>
                <span className='text-[#FF689A] text-[3.9vw] font-vwsemibold sm:text-[2vw] lg:text-[1vw]'>${discountedPrice}</span>
                <strike className='text-[#171717] ml-[0.6vw] text-[3.8vw] sm:text-[1.5vw] lg:text-[0.8vw] font-medium'>${actualPrice}</strike>
            </p>
