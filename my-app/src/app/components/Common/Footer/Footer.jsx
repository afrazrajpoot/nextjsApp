...
const Footer = () => {
  return (
    <footer className='w-full p-[2vw] bg-[#171717]'>
        <main className='w-full max-w-[80vw] mx-auto mt-[2vw] flex flex-col md:flex-row items-start'>
        <section className='w-full md:max-w-[20vw]'>
        <Image src={"/img/logoText.png"} alt='logo' width={200} height={50} />
        <p className='text-[#525252] mt-[3.5vw] md:mt-[1.5vw] text-[4vw] md:text-[1vw] w-full md:max-w-[20vw]'>Market design is the process of designing markets to achieve specific goals.</p>
        </section>
        <section className='w-full md:max-w-[20vw] mt-[6vw] md:mt-0 md:ml-[10vw]'>
            <main className='grid grid-cols-1 md:grid-cols-2 gap-[5vw] md:gap-[1vw]'>
                ...
                <section key={index}>
                    <h1 className='text-[#A3A3A3] text-[4vw] md:text-[1vw]'>{list?.title}</h1>
                    <div className='text-[#ffff] text-[3.9vw] md:text-[0.9vw] mt-[3vw] md:mt-[1vw]'>
        ...
        <h1 className='text-[#ffff] text-[4vw] md:text-[1vw]'>Newsletter</h1>
      ...
      <TextField
          ...
          />
          <button className="bg-[#FF689A] text-[4vw] mt-[3vw] md:mt-0 md:text-[1vw] ml-[1vw] hover:shadow-md hover:bg-[#ff387af1] text-[#fff] p-[2.5vw] md:p-[0.9vw] rounded-md w-full md:max-w-[7vw] text-center">Submit</button>
      </section>
        </section>
        </main>
        <article className='w-full max-w-[80vw] mx-auto my-[6vw] md:my-[2vw] flex flex-col md:flex-row md:items-center'>
            <p className='text-[#FFFFFF] text-[3.9vw] md:text-[0.9vw] w-full md:max-w-[30vw]'>© 2022 Company Name® Global Inc.</p>
            ...
            <p className='flex items-center text-[#fff] mt-[3vw] md:mt-0 text-[3.9vw] md:text-[0.9vw]'>
