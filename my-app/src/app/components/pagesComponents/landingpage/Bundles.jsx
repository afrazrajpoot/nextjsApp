...
const Bundles = () => {
  ...
  return (
    ...
    <h1 className="text-[5.5vw] sm:text-[3.5vw] lg:text-[2.5vw] text-[#171717] font-semibold">Get Bundles</h1>
    <p className="text-[#B0B0B0] text-[4vw] sm:text-[2vw] lg:text-[1vw] mt-[0.5vw]">Unlimited Packs Get Every Pack We Have + Every Future Pack!</p>
