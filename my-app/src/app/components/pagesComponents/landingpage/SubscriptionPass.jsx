...
const SubscriptionPass = ({btnBg}) => {
  return (
    ...
    <section className='p-[2vw]'>
      ...
      <button className={`bg-[${btnBg ? btnBg : '#171717'}] mt-[3vw] md:mt-[1vw] border-[1px] border-[${btnBg ? btnBg : '#171717'}] hover:font-medium text-[4vw] md:text-[1vw] hover:shadow-md hover:bg-[#111111] text-[#fff] p-[2.5vw] md:p-[0.9vw] rounded-md w-full max-w-[30vw] md:max-w-[10vw] text-center`}>Get Access</button>
    </section>
