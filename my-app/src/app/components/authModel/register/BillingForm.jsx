...
const BillingForm = () => {
  return (
    <main className="">
      <form action="">
        {billingAddressFrom?.map((field, index) => (
          <div className={""}>
            <div key={index} className="lg:mb-6 mb-[3vw]">
              <label htmlFor={field.name} className="lg:text-[0.9vw] sm:text-[2.5vw]  text-[4vw] font-medium  text-[#1B1B1B]">
                {field.label}
              </label>
              <div className={field}>
                <input id={field.name} type={field?.type} require value={field.value}
        ...
        <div className="flex gap-[4vw] lg:gap-[2vw] ">
          <div className="flex flex-col">
            ...
            <input  type="text" name="" value={"Birmingham"}
          ...
          <div className="flex flex-col mb-6">
            ...
            <input type="text" name="" value={"3456"}
              className="bg-[#FAFAFA] p-[3vw] lg:p-[0.7vw] sm:text-[2vw] sm:p-[2vw] w-full focus:outline-none border-[1px] rounded-sm border-[#F5F5F5] lg:text-[0.9vw] text-[3.5vw] lg:w-[22vw] sm:w-[41vw]"
            />
          </div>
        </div>
